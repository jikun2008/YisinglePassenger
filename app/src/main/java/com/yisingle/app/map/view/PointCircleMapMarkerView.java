...
public class PointCircleMapMarkerView extends BaseMapMarkerView<PointCircleMapMarkerView.PointMapMarkerData, PointCircleMapMarkerView.PointMapWindowData> {
    ...
    @Override
    protected void addMarkSuccess(PointMapMarkerData markerData) {
