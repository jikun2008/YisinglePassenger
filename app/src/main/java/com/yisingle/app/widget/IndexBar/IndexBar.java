package com.yisingle.app.widget.IndexBar;
...
import com.yisingle.app.widget.IndexBar.helper.IIndexBarDataHelper;
import com.yisingle.app.widget.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(getResources().getColor(R.color.index_grey_text));
