...
public class YiSinglePassengerPresenterImpl extends BasePresenter<IYiSinglePassenger.IYiSinglePassengerView> implements IYiSinglePassenger.IYiSinglePassengerPresenter {
    ...
    private String TAG = YiSinglePassengerPresenterImpl.class.getSimpleName();

    public YiSinglePassengerPresenterImpl(IYiSinglePassenger.IYiSinglePassengerView view) {
        super(view);
                    ...
                    if (JsonUtils.isGoodJson(respones)) {
                        ...
                        switch (headData.getType()) {
                            ...
                            case SocketData.Type.PRICIE_ORDER:
                                Logger.e("socket收到数据类型是:" + "SocketData.Type.PRICIE_ORDER");
                                SocketData<OrderData> priceSocketData = gson.fromJson(respones, new TypeToken<SocketData<OrderData>>() {
                                }.getType());
