...
public class FastCarPresenterImpl extends BasePresenter<IFastCar.FastCarView> implements IFastCar.FastCarPresenter {
    ...
    public FastCarPresenterImpl(IFastCar.FastCarView view) {
        super(view);
    }
    ...
    public void getRegeocodeAddress(Context context, LatLng latLng, int type) {
        ...
        Observable<RegeocodeAddress> observable1 = RxMapManager.getInstance().
